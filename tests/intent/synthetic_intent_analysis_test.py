        ...
        analysis = {'age': {'associate': 'age',
                    ...
                    'fnlwgt': {'associate': 'fnlwgt',
                               'analysis': {'intent': {'selection': [(12285, 1490400, 'both')],
                                                       ...
                                                       'freq_precision': 2},
                                            'patterns': {'relative_freq': [100.0],
                                                         'freq_mean': [189664.135],
                                                         'freq_std': [11152210185.575],
                                                         'sample_distribution': [48842],
                    ...
                    'marital-status': {'associate': 'marital-status',
                                       'analysis': {'intent': {'selection': ['marital-status_Married-civ-spouse',
                                                               ...
                                                               'freq_precision': 2},
                                                    'patterns': {
                                                        'relative_freq': [45.82, 33.0, 13.58, 3.13, 3.11, 1.29, 0.08],
                    ...
                    'relationship': {'associate': 'relationship',
                                     'analysis': {'intent': {'selection': ['relationship_Husband',
                                                             ...
                                                             'freq_precision': 2},
                                                  'patterns': {
                                                      'relative_freq': [40.37, 25.76, 15.52, 10.49, 4.77, 3.08],
                    ...
                    'race': {'associate': 'race',
                             'analysis': {'intent': {'selection': ['race_White',
                                                     ...
                                                     'granularity': 5,
                                                     'freq_precision': 2},
                                          'patterns': {'relative_freq': [85.5, 9.59, 3.11, 0.96, 0.83],
                    ...
                    'gender': {'associate': 'gender',
                               'analysis': {'intent': {'selection': ['gender_Male', 'gender_Female'],
                                                       ...
                                                       'granularity': 2,
                                                       'freq_precision': 2},
                                            'patterns': {'relative_freq': [66.85, 33.15],
                    ...
                    'income': {'associate': 'income',
                               'analysis': {'intent': {'selection': [(0, 1, 'both')],
                                            ...
                                            'stats': {'nulls_percent': 0.0,
                                                      ...
                                                      'kurtosis': -0.51}}}}
        sample_size = 10000
        result = self.tools.model_analysis(pd.DataFrame(index=range(sample_size)), analysis, save_intent=False)
